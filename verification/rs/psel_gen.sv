/*
    ...
    Module can help avoid long chains of hardware generated by dependent for-loops.
    ...
    between granting the most-significant and least-significant **active** request bits. 
    ...
    Example 4) Active request bits versus request bits
    req        = 001111 (Input)
    gnt        = 001101
    gnt_bus[0] = 001000 (the gnt bus alternates only amongst active requesters)
    gnt_bus[1] = 000001
    gnt_bus[2] = 000100
    empty      = 0
