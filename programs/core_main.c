...
//Personal Adaptations For Mem Output
#define OUTPUT_BASE 0x8000
#define CRC_ADDR   (*(volatile int*)(OUTPUT_BASE + 0))
#define ITER_ADDR  (*(volatile int*)(OUTPUT_BASE + 4))
#define DONE_ADDR  (*(volatile int*)(OUTPUT_BASE + 8))
